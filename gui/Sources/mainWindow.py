...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widgControl = QtWidgets.QWidget(self.centralwidget)
        self.widgControl.setGeometry(QtCore.QRect(10, 0, 231, 51))
        self.widgControl.setObjectName("widgControl")
        self.btnCreate = QtWidgets.QPushButton(self.widgControl)
        self.btnCreate.setGeometry(QtCore.QRect(0, 10, 71, 28))
        self.btnCreate.setObjectName("btnCreate")
        self.btnEdit = QtWidgets.QPushButton(self.widgControl)
        self.btnEdit.setGeometry(QtCore.QRect(80, 10, 71, 28))
